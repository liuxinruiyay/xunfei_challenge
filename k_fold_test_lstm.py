...
def evaluate_k_fold(model_list, test_data_loader):
    ...
    for model in model_list:
        load_path = "./pretrain_kfold_lstm/"+model
...
model_list = ["0-model-0.798.pt", "1-model-0.7924.pt", "2-model-0.7964.pt", "3-model-0.793.pt", "4-model-0.7782.pt", "5-model-0.781.pt", "6-model-0.782.pt", "7-model-0.7848.pt", "8-model-0.781.pt", "9-model-0.7906.pt"]
